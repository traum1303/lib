...
@section('content')
    <div class="max-w-3xl mx-auto px-4 py-8">
        ...
        <form method="POST" action="{{ route('books.store') }}" class="bg-white border border-gray-200 rounded-lg shadow-sm">
            @csrf
            @method('POST')
            ...
            <div class="p-6 bg-gray-50 border-t border-gray-100 flex items-center justify-end gap-3">
                <a href="{{ route('books.index') }}" class="px-4 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100">
                    Отмена
                </a>
